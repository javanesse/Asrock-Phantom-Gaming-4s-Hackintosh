 ...
 *
 * Disassembly of /Users/javanesse/Desktop/origin copy/SSDT-1-CpuSsdt.aml, Thu Dec 17 01:45:40 2020
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00001B1C (6940)
 *     Revision         0x02
 *     Checksum         0x80
 *     OEM ID           "CpuRef"
...
DefinitionBlock ("", "SSDT", 2, "CpuRef", "CpuSsdt", 0x00003000)
{
    ...
    {
        Name (CTPC, Zero)
        OperationRegion (PNVS, SystemMemory, 0x76DD6000, 0x0070)
    ...
    Scope (\_SB.PR00)
    {
        ...
        Method (COSC, 4, NotSerialized)
        {
            ...
            Store (ToUUID ("4077a616-290c-47be-9ebd-d87058713953") /* Unknown UUID */, Local0)
