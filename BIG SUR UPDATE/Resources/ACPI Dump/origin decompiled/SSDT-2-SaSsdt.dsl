 ...
 *
 * Disassembly of /Users/javanesse/Desktop/origin copy/SSDT-2-SaSsdt.aml, Thu Dec 17 01:45:40 2020
 *
...
DefinitionBlock ("", "SSDT", 2, "SaSsdt", "SaSsdt ", 0x00003000)
{
    ...
    OperationRegion (SANV, SystemMemory, 0x76488118, 0x01F4)
    ...
    Scope (\_SB.PCI0.IPU0)
    {
        ...
        {
            If (LEqual (Arg0, ToUUID ("9a9e6ab4-e3fc-475d-ad1c-c4789e4cfe90") /* Unknown UUID */))
            {
                If (LEqual (Arg2, Zero))
                {
                    If (LEqual (Arg1, Zero))
