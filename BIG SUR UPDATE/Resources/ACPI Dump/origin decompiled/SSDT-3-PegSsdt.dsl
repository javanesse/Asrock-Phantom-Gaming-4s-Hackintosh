 ...
 *
 * Disassembly of /Users/javanesse/Desktop/origin copy/SSDT-3-PegSsdt.aml, Thu Dec 17 01:45:40 2020
 *
...
DefinitionBlock ("", "SSDT", 2, "PegSsd", "PegSsdt", 0x00001000)
{
    ...
    Scope (\_SB.PCI0)
    {
        ...
        Method (PGON, 1, Serialized)
        {
            ...
            If (LEqual (PION, Zero))
            {
                Store (H0VI, S0VI) /* \_SB_.PCI0.S0VI */
                Store (H0DI, S0DI) /* \_SB_.PCI0.S0DI */
                Or (And (ELC0, 0x43), And (LCT0, 0xFFBC), LCT0) /* \_SB_.PCI0.LCT0 */
            }
            ElseIf (LEqual (PION, One))
            {
                Store (H1VI, S1VI) /* \_SB_.PCI0.S1VI */
                Store (H1DI, S1DI) /* \_SB_.PCI0.S1DI */
                Or (And (ELC1, 0x43), And (LCT1, 0xFFBC), LCT1) /* \_SB_.PCI0.LCT1 */
            }
            ElseIf (LEqual (PION, 0x02))
            {
                Store (H2VI, S2VI) /* \_SB_.PCI0.S2VI */
                Store (H2DI, S2DI) /* \_SB_.PCI0.S2DI */
