 ...
 *
 * Disassembly of /Users/javanesse/Desktop/origin copy/SSDT-4-CflS_Rvp.aml, Thu Dec 17 01:45:40 2020
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00001C01 (7169)
 *     Revision         0x02
 *     Checksum         0x9C
 *     OEM ID           "ALASKA"
 ...
 */
DefinitionBlock ("", "SSDT", 2, "ALASKA", "CflS_Rvp", 0x00001000)
{
    ...
    Scope (\_SB.PCI0.RP09)
    {
        ...
        Method (PALC, 1, Serialized)
        {
            ...
            ElseIf (LGreater (Arg0, CURP))
            {
                Subtract (Arg0, CURP, Local0)
                If (RAPC (One, Local0))
                {
                    Store (Arg0, CURP) /* \_SB_.PCI0.RP09.CURP */
                    Return (One)
                }
                Else
                {
    ...
    Scope (\_SB.PCI0.RP21)
    {
        ...
        Method (PALC, 1, Serialized)
        {
            ...
            ElseIf (LGreater (Arg0, CURP))
            {
                ...
                If (RAPC (One, Local0))
                {
                    Store (Arg0, CURP) /* \_SB_.PCI0.RP21.CURP */
                    Return (One)
                }
                Else
                {
    ...
    Scope (\_SB.PCI0.PEG0)
    {
        ...
        Method (PALC, 1, Serialized)
        {
            ...
            ElseIf (LGreater (Arg0, CURP))
            {
                ...
                If (RAPC (One, Local0))
                {
                    Store (Arg0, CURP) /* \_SB_.PCI0.PEG0.CURP */
                    Return (One)
                }
                Else
                {
    ...
    Scope (\_SB.PCI0.SAT0)
    {
        ...
        Scope (PRT1)
        {
            ...
            If (LAnd (And (RCG0, One), One))
            {
                ...
                Scope (\_GPE)
                {
                    ...
                    {
                        ADBG ("ZPODD event")
                        If (LEqual (\_SB.GGIV (0x03040001), Zero))
                        {
                            ADBG ("ODD detected")
        ...
        Method (ZPOD, 3, Serialized)
        {
            ...
            Switch (ToInteger (Arg1))
            {
                ...
                Case (0x02)
                {
                    Store (ToInteger (DerefOf (Index (Arg2, Zero))), DRV) /* \_SB_.PCI0.SAT0.DRV_ */
                    Store (ToInteger (DerefOf (Index (Arg2, One))), PWR) /* \_SB_.PCI0.SAT0.PWR_ */
