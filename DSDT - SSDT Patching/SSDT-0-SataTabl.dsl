 ...
 *
 * Disassembly of SSDT-0-SataTabl.aml, Thu Jun  6 20:59:04 2019
 *
...
DefinitionBlock ("", "SSDT", 1, "SataRe", "SataTabl", 0x00001000)
{
    ...
    External (_SB_.PCI0.SATA.PRT0, DeviceObj)    // (from opcode)
    External (_SB_.PCI0.SATA.PRT1, DeviceObj)    // (from opcode)
    External (_SB_.PCI0.SATA.PRT2, DeviceObj)    // (from opcode)
    External (_SB_.PCI0.SATA.PRT3, DeviceObj)    // (from opcode)
    External (_SB_.PCI0.SATA.PRT4, DeviceObj)    // (from opcode)
    External (_SB_.PCI0.SATA.PRT5, DeviceObj)    // (from opcode)
